...
export default function Robot({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/robot_lean.glb')
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[-2.52, 6.65, -0.66]} rotation={[-Math.PI, 1.13, 3.07]} scale={[0.07, 0.1, 0.07]}>
        <primitive object={nodes.Bone001} />
        <skinnedMesh geometry={nodes.Cube.geometry} material={materials['Material.008']} skeleton={nodes.Cube.skeleton} />
        <skinnedMesh geometry={nodes.Cube003.geometry} material={materials['Material.008']} skeleton={nodes.Cube003.skeleton} />
      </group>
      <group position={[0.9, 6.75, -0.61]} rotation={[0, 1.13, -Math.PI]} scale={[-0.07, -0.09, -0.07]}>
      ...
      <mesh geometry={nodes.Cubo004.geometry} material={materials['Material.005']} position={[-0.59, 7.11, -1.08]} rotation={[0.17, 0, 0]} scale={[0.74, 0.16, -0.03]}>
        <mesh geometry={nodes.Cubo.geometry} material={materials['Material.004']} position={[0, 6.44, -3.58]} scale={[1, 4.11, 4.67]} />
        <group position={[0, 5.09, 22.41]} rotation={[0, 0, -Math.PI]} scale={[-1, -6.07, -21.36]}>
          <mesh geometry={nodes.Cubo002_1.geometry} material={materials['Material.002']} />
          <mesh geometry={nodes.Cubo002_2.geometry} material={materials['Material.001']} />
        </group>
        ...
        <mesh geometry={nodes.Cubo003.geometry} material={materials['Material.002']} position={[0, 1.67, -2.39]} rotation={[0, 0, -Math.PI]} scale={[-1, -0.67, -3.39]} />
        <mesh geometry={nodes.Plano.geometry} material={materials.Material} position={[1.01, -0.53, 19.5]} rotation={[-1.26, -0.53, -0.94]} scale={[10.78, 0.31, 0.18]} />
        <mesh geometry={nodes.Plano001.geometry} material={materials.Material} position={[1.01, -0.24, 19.5]} rotation={[-1.26, -0.53, -0.94]} scale={[10.78, 0.31, 0.18]} />
        <mesh geometry={nodes.Plano002.geometry} material={materials.Material} position={[1.01, 0.04, 19.5]} rotation={[-1.26, -0.53, -0.94]} scale={[10.78, 0.31, 0.18]} />
        ...
        <mesh geometry={nodes.Plano004.geometry} material={materials['Material.002']} position={[1.01, 0.24, 19.51]} rotation={[-1.26, -0.53, -0.94]} scale={[10.78, 0.3, 0.11]} />
      </mesh>
      ...
      <group position={[-0.81, 7.29, 2.65]} rotation={[1.92, 0, 0]} scale={[1.2, 0.11, 0.91]}>
        <mesh geometry={nodes.Cubo007.geometry} material={materials['Material.013']} />
        <mesh geometry={nodes.Cubo007_1.geometry} material={materials['Material.001']} />
        <mesh geometry={nodes.Cubo007_2.geometry} material={materials['Material.016']} />
      </group>
      ...
      <mesh geometry={nodes.Curva_NURBS004.geometry} material={materials['Material.009']} position={[0.44, 6.15, 1.13]} rotation={[-0.24, Math.PI / 2, 0]} />
...
useGLTF.preload('/robot_lean.glb')
